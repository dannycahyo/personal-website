  ...
  return (
    <Layout>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://dannydwicahyono.com/about"
        />
        <meta
          property="og:url"
          content="https://dannydwicahyono.com/about"
        />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="About Danny Dwi Cahyono" />
        <meta
          property="og:description"
          content="Welcome to my About page! Here, you'll find everything you need to know about me and my mission. I'm committed to achieving my goals and making a positive impact on the world through continuous learning, content creation, speaking at conferences, and leading workshops. My values include integrity, collaboration, and kindness. Thanks for visiting my About page!"
        />
        <meta
          property="og:image"
